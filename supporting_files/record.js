...
function getMicrophoneAccess() {
  ...
  navigator.getUserMedia({
    ...
    var sourceView = new SpectogramAnalyzerNodeView(sourceAnalyserNode, document.getElementById("source_spectrogram"), 320, 100);
    var destinationView = new SpectogramAnalyzerNodeView(destinationAnalyserNode, document.getElementById("destination_spectrogram"), 320, 100);
    function tick() {
      sourceView.tick();
